...
public class CustomerInformation extends ImageGroup 
{
	...
	public void build() 
	{
      	...
      	try
		{
			...
			while (diimgSet.next())
			{
				...
				if(count == 1)
				{
					File theDir = new File( "C:\\FUBGlobal360_xmlexport\\CIF\\set" + dirNum);
					theDir.mkdir();
					fileName = "C:\\FUBGlobal360_xmlexport\\CIF\\set" + dirNum + "\\" + diimgSet.getString("DIOBJNO") + ".xml";
				}
				else if( count < 50000)
				{
					fileName = "C:\\FUBGlobal360_xmlexport\\CIF\\set" + dirNum + "\\" + diimgSet.getString("DIOBJNO") + ".xml";
